...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/sidebar.css?version=1">
...
<div id="navbar">
	<ul>
		...
		<li><a href="hg.php">Colors</a></li>
		<li><a href="hg.php">Tools</a></li>
...
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price FROM products WHERE category='Apsara' AND fandom='Pencils' ORDER BY id ASC");
if($results){
...
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price FROM products WHERE category='Staedtler' AND fandom='Pencils' ORDER BY id ASC");
if($results){
$products_item = '<ul style="list-style-type: none;">';
//fetch results set as object and output HTML
...
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price FROM products WHERE category='Faber Castell' AND fandom='Pencils' ORDER BY id ASC");
if($results){
$products_item = '<ul style="list-style-type: none;">';
//fetch results set as object and output HTML
